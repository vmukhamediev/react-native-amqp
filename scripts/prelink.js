try {
    ...
    var PACKAGE_GRADLE = process.cwd() + '/node_modules/react-native-amqp/android/build.gradle'
    ...
    function checkVersion() {
        console.log('react-native-amqp checking app version ..');
        return parseFloat(/\d\.\d+(?=\.)/.exec(package.dependencies['react-native']));
    }

} catch(err) {
  console.log(
    '\033[95mreact-native-amqp\033[97m link \033[91mFAILED \033[97m\nCould not automatically link package :'+
    err.stack)
}
